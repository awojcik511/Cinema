    ...
    <div class="col s12 m6">
      <div class="card">
        <div class="card-image">
          <img src="img/filmy/3.png">
          <span class="card-title">Ciche miejsce</span>
        </div>
		...
		$result=mysql_query('
			Select opis from film where tytul like "Cich%"
			');
		...
		<div class="col s12 m6">
          <div class="icon-block">
			...
			join gatunek on gatunekfilmu.ID_gatunku=gatunek.ID_gatunku where Tytul LIKE 'Cich%'
	Group By tytul
");
			echo('
    ...
    <div class="section">
      ...
      <div class="row">
          ...
          <?php
			...
			$polacz2=mysql_select_db('kino1',$polacz)  or die ("Nie połaczono z bazą" );
			$result=mysql_query('
			SELECT imie, nazwisko, postac from aktorzy inner join obsada on aktorzy.ID_aktora=obsada.ID_aktora where ID_film=3
			');
