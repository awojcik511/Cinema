    ...
    <ul class="slides">
      ...
      <li>
        ...
        <div class="caption right-align">
		  ...
		  Historia życia Jerzego Górskiego,<br> który mimo wielu przeciwności został<br> mistrzem świata w podwójnym triatlonie
		 .</h5>
        </div>
      </li>
    </ul>
    ...
    <div class="col s12 m6">
      <div class="card">
        <div class="card-image">
          <img src="img/filmy/4.jpg">
          <span class="card-title">Najlepszy</span>
        </div>
		...
		$result=mysql_query('
			Select opis from film where tytul like "Naj%"
			');
        ...
        <div class="card-action">
          <a href="https://www.filmweb.pl/review/Born+To+Be+Wild-20922">Recenzja</a>
        </div>
      </div>
    </div>
		...
		<div class="col s12 m6">
          <div class="icon-block">
			...
			join gatunek on gatunekfilmu.ID_gatunku=gatunek.ID_gatunku where Tytul LIKE 'Naj%'
	Group By tytul
");
			echo('
    ...
    <div class="section">
      ...
      <div class="row">
          ...
          <?php
			...
			mysql_query("SET NAMES 'utf8'");
			$result=mysql_query('
			SELECT imie, nazwisko, postac from aktorzy inner join obsada on aktorzy.ID_aktora=obsada.ID_aktora where ID_film=4
			');
