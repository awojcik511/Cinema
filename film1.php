    ...
    <div class="col s12 m6">
      <div class="card">
        <div class="card-image">
          <img src="img/filmy/1.jpg">
          <span class="card-title">Czerwona jaskółka</span>
        </div>
		...
		$result=mysql_query('
			Select opis from film where tytul like "Czerwona%"
			');
        ...
        <div class="card-action">
          <a href="https://www.filmweb.pl/review/Poskromienie+baletnicy-21154">Recenzja</a>
        </div>
      </div>
    </div>
		...
		<div class="col s12 m6">
          <div class="icon-block">
			...
			join gatunek on gatunekfilmu.ID_gatunku=gatunek.ID_gatunku where Tytul LIKE 'Czer%'
	Group By tytul
");
			echo('
    ...
    <div class="section">
      ...
      <div class="row">
          ...
          <?php
			...
			$polacz2=mysql_select_db('kino1',$polacz)  or die ("Nie połaczono z bazą" );
			$result=mysql_query('
			SELECT imie, nazwisko, postac from aktorzy inner join obsada on aktorzy.ID_aktora=obsada.ID_aktora where ID_film=1
			');
